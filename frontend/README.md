...
- **/my-leaves** — İzin Talebi: izin talep formu + taleplerim tablosu
- **/leave-requests** — İzin Yönetimi: bekleyen talepler, onayla/reddet (sadece MANAGER rolü)
...
- Korumalı rotalar: token yoksa `/login`'e yönlendirilir; EMPLOYEE rolü `/leave-requests`'e giremez.
